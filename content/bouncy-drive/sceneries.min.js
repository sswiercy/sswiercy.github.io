...
resources.sceneries.snowscape.obstacles.rock.image(),c[0].particle.motion.position.translation.negate()))},sound:resources.sceneries.snowscape.obstacles.rock.sound}],this.TRACK_OFFSET())}}};sceneries.utility.Setup.prototype.tuneDistance=function(a,b){return a*Math.pow(b,this.distance)};sceneries.utility.Setup.prototype.tuneFirstRange=function(a){return(new game.utility.Range(-this.uphill,this.downhill)).multiply(a)};
sceneries.utility.Setup.prototype.tuneSecondRange=function(a,b){return game.utility.Range.symmetric(a*Math.pow(b,this.alternation))};sceneries.utility.Setup.prototype.tuneInverseObstacles=function(a,b){return Math.pow(this.obstacles,b)/a};sceneries.utility.Builder.SAMPLE_TOLERANCE=function(){return Math.pow(.025*game.View.PX_PER_M,2)};sceneries.utility.Builder.SAMPLE_DISTANCE=function(){return.25*game.View.PX_PER_M};sceneries.utility.Builder.TERRAIN_HEIGHT=new physics.dynamics.Vector(0,1E4);
sceneries.utility.Builder.CHAIN_SPAN=function(){return(new physics.dynamics.Vector(0,3)).multiply(game.View.PX_PER_M)};sceneries.utility.Builder.TRACK_LIMIT_EXTENT=function(){return 10*game.View.PX_PER_M};sceneries.utility.Builder.LOADING_MARGIN=function(){return physics.dynamics.Rectangle.symmetric(physics.dynamics.Vector.fromOne(game.loading.Loader.TOGGLE_LINE_WIDTH/4))};
...
g)))})};sceneries.grassland.COST=1E4;sceneries.grassland.DIFFICULTY_MAX_MULTIPLIER=2.5;sceneries.grassland.PROPERTY_PATH=["grassland"];sceneries.grassland.TRACK_OFFSET=function(){return 50*game.View.PX_PER_M};sceneries.grassland.TREE_OFFSET=function(){return 20*game.View.PX_PER_M};sceneries.grassland.VEHICLE_OFFSET=function(){return 30*game.View.PX_PER_M};sceneries.grassland.BARN_OFFSET=function(){return 40*game.View.PX_PER_M};sceneries.grassland.BIRDS_DURATION=600;
sceneries.grassland.BIRDS_PARALLAX_SIZE=new physics.dynamics.Vector(2500,1E3);sceneries.grassland.BACKGROUND_MULTIPLIER=.04;sceneries.grassland.BIRDS_HEIGHT_RANGE=function(){return new game.utility.Range(.25,.5)};sceneries.grassland.GRASS_DURATION=2;sceneries.grassland.TREE_DURATION=5;
...
649.54),new physics.dynamics.Vector(975,644.07),new physics.dynamics.Vector(1E3,640.92)];sceneries.city.ROADBLOCK_LIGHTS_OFFSET=30;sceneries.city.ROADBLOCK_FLASH_DURATION=physics.utility.PI_2/4;sceneries.city.SPEED_BUMP_SCALING=.75;sceneries.city.PYLON_SCALING=.3;sceneries.city.COBBLESTONE_SCALING=.35;sceneries.snowscape.COST=25E4;sceneries.snowscape.DIFFICULTY_MAX_MULTIPLIER=3;sceneries.snowscape.PROPERTY_PATH=["snowscape"];sceneries.snowscape.TRACK_OFFSET=function(){return 50*game.View.PX_PER_M};
sceneries.snowscape.BACKGROUND_MULTIPLIER=.02;sceneries.snowscape.BACKGROUND_COLOR_STR="#525666";sceneries.snowscape.BACKGROUND_COLOR=physics.rendering.Color.fromCss(sceneries.snowscape.BACKGROUND_COLOR_STR);sceneries.snowscape.BACKGROUND_LIGHTNING_COLOR=physics.rendering.Color.fromCss("#7b8199");sceneries.snowscape.BACKGROUND_HEIGHT=1E3;sceneries.snowscape.STONEWALL_OFFSET=function(){return 20*game.View.PX_PER_M};sceneries.snowscape.STONEWALL_WIDTH_2=function(){return.375*resources.sceneries.snowscape.stonewall().width};
sceneries.snowscape.VEHICLE_OFFSET=function(){return 30*game.View.PX_PER_M};sceneries.snowscape.STABBUR_OFFSET=function(){return 40*game.View.PX_PER_M};sceneries.snowscape.STABBUR_SCALING=.7;sceneries.snowscape.BARREL_MULTIPLIER=.03;sceneries.snowscape.BARREL_OFFSET=20*sceneries.snowscape.STABBUR_SCALING;sceneries.snowscape.DOOR_BACKGROUND_OFFSET=(new physics.dynamics.Vector(-300,-930)).multiply(sceneries.snowscape.STABBUR_SCALING);
