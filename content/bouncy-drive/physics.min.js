...
physics.collections.Bundle.prototype.release=function(){if(!this.removers.length)return!1;this.removers.forEach(function(a){a()});this.removers=[];return!0};physics.collections.Ordered.prototype.add=function(a){if(this.set.has(a))console.warn("Adding already existing value to ordered collection",this,a);else return this.set.add(a),a};physics.collections.Ordered.prototype.remove=function(a){this.set.delete(a)||console.warn("Removing non-existing value from ordered collection",this,a)};
physics.collections.Ordered.prototype.values=function(){const a=[];this.set.forEach(function(b){a.push(b)});return a};physics.collections.Sorted.byOrder=function(){return new physics.collections.Sorted(function(a,b){return a.order()-b.order()})};physics.collections.Sorted.prototype.binarySearch=function(a){return physics.utility.binarySearch(this.data,function(b){return 0>this.compare(b.values().next().value,a)}.bind(this))};
physics.collections.Sorted.prototype.add=function(a){const b=this.binarySearch(a);(b==this.data.length||0<this.compare(this.data[b].values().next().value,a))&&this.data.splice(b,0,new Set);if(this.data[b].has(a))console.warn("Adding already existing value to sorted collection",this,a);else return this.data[b].add(a),a};
physics.collections.Sorted.prototype.remove=function(a){const b=this.binarySearch(a);b<this.data.length&&this.data[b].delete(a)?0==this.data[b].size&&this.data.splice(b,1):console.warn("Removing non-existing value from sorted collection",this,a)};physics.collections.Sorted.prototype.values=function(){const a=[];this.data.forEach(function(b){b.forEach(function(c){a.push(c)})});return a};physics.collections.Immutable.prototype.values=function(){return this.data.slice()};
...
physics.rendering.graphics.Alpha.prototype.bounds=function(){return this.graphic.bounds()};physics.rendering.graphics.Alpha.prototype.updating=function(){return this.graphic.updating()};physics.rendering.graphics.Alpha.prototype.render=function(){const a=this.context.context2d.globalAlpha;this.context.context2d.globalAlpha=a*this.mapper(this.context.position(this.particle));this.graphic.render();this.context.context2d.globalAlpha=a};physics.rendering.graphics.Offset.prototype.bounds=function(){return this.graphic.bounds().add(this.translation)};
physics.rendering.graphics.Offset.prototype.updating=function(){return this.graphic.updating()};physics.rendering.graphics.Offset.prototype.render=function(){this.context.doTranslated(this.translation,this.graphic.render.bind(this.graphic))};physics.rendering.graphics.FlippedX.prototype.bounds=function(){return this.graphic.bounds().flipX()};physics.rendering.graphics.FlippedX.prototype.updating=function(){return this.graphic.updating()};physics.rendering.graphics.FlippedX.prototype.render=function(){this.context.doFlippedX(this.graphic.render.bind(this.graphic))};
