...
game.hud.Tuning.prototype.decrement=function(){this.value--;this.update()};game.hud.Tuning.prototype.canIncrement=function(){return this.value<this.maxValue};game.hud.Tuning.prototype.increment=function(){this.value++;this.update()};game.hud.Difficulty.DECREASE_COUNT=3;game.hud.Difficulty.TARGET_WEIGHT=.01;game.hud.Difficulty.TARGET_WEIGHT_LOG=Math.log(game.hud.Difficulty.TARGET_WEIGHT);game.hud.Difficulty.TARGET_WEIGHT_ZERO=game.hud.Difficulty.TARGET_WEIGHT/10;
